...
// Define Stat interface here as well to avoid circular dependency
 ...
 */
export function getTimestamp(dateObj: Date | string | undefined): number {
 ...
 */
export function createStat(options: CreateStatOptions = {}): Stat {
	...
	return {
		...
		gid: options.gid || (typeof process.getgid === 'function' ? process.getgid() : 0),
	};
}
 ...
 */
export function createSafeDate(dateString: string | undefined): Date | undefined {
